...
def run_sequence(cf):
    ...
    '''
    for _ in range(200):
        set_motor_powers(65535*0, 0, 32767, 0)
        time.sleep(0.01)

    for _ in range(200):
        set_motor_powers(65535*0.2, 0, 32767, 0)
        time.sleep(0.01)

    for _ in range(200):
        set_motor_powers(65535*0.4, 0, 32767, 0)
        time.sleep(0.01)

    for _ in range(200):
        set_motor_powers(65535*0.6, 0, 32767, 0)
        time.sleep(0.01)

    for _ in range(200):
        set_motor_powers(65535*0.8, 0, 32767, 0)
        time.sleep(0.01)

    for _ in range(200):
        set_motor_powers(65535*1, 0, 32767, 0)
        time.sleep(0.01)           
